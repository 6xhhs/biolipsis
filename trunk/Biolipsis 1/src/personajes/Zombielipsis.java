...
public class Zombielipsis extends Enemigos implements ZombieMoviles {

    private static final String ARCHIVO = "/zombieGordo.png";
    private static int VIDA = 6;
    private static final int VIDA_TOTAL = 6;
    private boolean banderaMorir;

    public Zombielipsis() throws IOException {
        super(ARCHIVO);
