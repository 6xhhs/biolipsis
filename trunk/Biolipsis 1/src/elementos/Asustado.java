 ...
 * @author Diego Zamora
 */
public class Asustado extends ElementosDeNivel {

    private static final String archivo = "/nivel2/asustado.png";
    private static int alto = 48;
    private static int ancho = 51;
     ...
     */
    public Asustado() throws IOException {
