 ...
 * @author Diego Zamora
 */
public class Temblorin extends ElementosDeNivel {

    private static final String archivo = "/nivel3/temblorin.png";
    private static int alto = 53;
    private static int ancho = 47;
    private static int[] secuencia = {0,0,1,1};
     ...
     */
    public Temblorin() throws IOException {
